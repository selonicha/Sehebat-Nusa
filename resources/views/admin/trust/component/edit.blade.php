        ...
        <div class="modal-content" style="background-color:var(--background-color)">
            <div class="modalHeader p-2">
                <div class="row">
                    <div class="col-10 justify-content-center align-items-center d-flex">
                        <h4 class="fw-bold d-flex justify-content-center" style="padding-left:45px">Edit Dipercayai Lembaga</h4>
                    </div>
            ...
            <div class="modal-body" style="padding:15px">
                <form action="" method="post" class="" style="">
                    @csrf
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Nama lembaga</label>
                        <input type="text" class="form-control" id="title" aria-describedby="titleHelp" name="judul" placeholder="">
                    </div>
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Logo lembaga</label>
