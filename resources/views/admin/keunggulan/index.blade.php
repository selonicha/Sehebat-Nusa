...
<section class="home-section">
    ...
    <div class="main-section p-5">
        <div class="summary pb-5">
            <h4 class="">Singkat keunggulan</h4>
...
@include('admin.keunggulan.component.create')
@include('admin.keunggulan.component.edit')
@include('admin.keunggulan.component.delete')
